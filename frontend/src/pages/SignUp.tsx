...
export default function SignUp({
  ...
  const [checkedAuthentication, setCheckedAuthentication] =
    useState<boolean>(false); //인증번호 맞는지 T/F변수
      ...
      <View style={styles.signWrap}>
        ...
        <View style={styles.authBox}>
          <TextInput
            ...
            onChangeText={handleIdInput}></TextInput>
        ...
        <View style={styles.authBox}>
          <TextInput
            ...
            placeholderTextColor="#929292"
            onChangeText={handlePhone}></TextInput>
          <TouchableOpacity
            style={styles.buttonBox}
            onPress={handleGetAuthentication}>
        ...
        {!compareViewAuth ? null : (
          <View style={styles.authBox}>
            <TextInput
              ...
              placeholder="인증 번호"
              placeholderTextColor="#929292"
              onChangeText={handleAuthentication}></TextInput>
            <TouchableOpacity
              style={styles.buttonBox}
              onPress={handleSetAuthentication}>
